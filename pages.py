...
class admin_page(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        frametop = framesconfig.frame_top( 0, 0, "nsew")
        framemiddle = framesconfig.frame_middle( 1, 0, "nsew")
        ...
        self.framemiddle.columnconfigure(1, weight=1)
        self.framemiddle.columnconfigure(2, weight=1)
        # Row Config
        self.frametop.rowconfigure(0, weight=1)
        self.framemiddle.rowconfigure(0, weight=1)
        self.framemiddle.rowconfigure(1, weight=1)
        self.framemiddle.rowconfigure(2, weight=1)

        # Text admin
        self.string_wlcm = tkinter.StringVar(value="Welcome A D M I N")
        self.label_wlcm = ctk.CTkLabel(master=self.frametop, textvariable=self.string_wlcm, width=120,
                                                  height=25)
        self.label_wlcm.grid(row=0, column=0, columnspan=2, padx=10, pady=10)

        # Quit Button
        self.quit_button = QuitButton(self.framemiddle, controller)
